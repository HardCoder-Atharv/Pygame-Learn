...
player_run = Animation("player","player_animations/run/","run_",2,3,(player_transformed.get_width(),player_transformed.get_height()),(player_rect.x-scroll[0],player_rect.y-scroll[1]))

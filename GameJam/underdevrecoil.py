...
player_run = Animation("player","player_animations/run/","",3,5,(player_transformed.get_width(),player_transformed.get_height()),(player_rect.x-scroll[0],player_rect.y-scroll[1]))
player_idle = Animation("player","player_animations/idle/","",3,6,(player_transformed.get_width(),player_transformed.get_height()),(player_rect.x-scroll[0],player_rect.y-scroll[1]))
